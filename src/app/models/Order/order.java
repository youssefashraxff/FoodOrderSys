...
public class order {
    ...
    public void displayOrder(){
        System.out.println("\njava.java.models.Order added successfully\n");
        System.out.println("Customer name: " + username);
        System.out.println("java.java.models.Restaurant Name: " + RestaurantName);
        System.out.println("Delivery Address: " + DeliveryAddress);
        System.out.println("Delivery Time: " + DeliveryTime);
        System.out.print("java.java.models.Order Payment: ");
        ...
        System.out.println("java.java.models.Order : ");
    ...
    public void displayOrder_start(){
        System.out.println("Customer name: " + username);
        System.out.println("java.java.models.Restaurant Name: " + RestaurantName.toUpperCase());
        System.out.println("Delivery Address: " + DeliveryAddress);
        System.out.println("Delivery Time: " + DeliveryTime);
        System.out.print("java.java.models.Order Payment: ");
        if(OrderPayment.getCardType().equals("Cash")){
