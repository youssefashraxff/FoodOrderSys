...
import app.models.Restaurant.displayMenu;
...
public class search_filter {
    ...
    public static void filterRestaurantsMenu(Scanner input) {
        ...
        System.out.println("2. java.java.models.Restaurant ratings");
        System.out.print("\nEnter your choice: ");

        int filterChoice = foodSys.getValidInt(input);

        switch (filterChoice) {
            case 1 -> search_filter.filterRestaurants_category();
            case 2 -> search_filter.filterRestaurants_Rating();
    ...
    public static void filterAndOrderRestaurants(ArrayList<restaurant> filteredRestaurants) {
        ...
        while (!orderChoice) {
            ...
            // Ask the java.java.models.user if they want to order another item or finish
